...
<body>
  <form action="friend.php" method="POST" enctype="multipart/form-data">
    <div class="row-1">
      <div class="form-group">
        ...
        <div class="well col-sm-12">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-12">
              <input type="text" class="form-control" id="fio" name="fio" placeholder="Петров Пётр Петрович">
            </div>
          </div>
          <br>
          <br>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-12">
              <input type="text" class="form-control" id="fiofriend" name="fiofriend" placeholder="Иванов Иван Иванович">
            </div>
          </div>
          <br>
          <div class="form-group">
            ...
            <div class="col-lg-12">
              <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="+78002500333">
            </div>
          </div>
          <br>
          <div class="form-group">
            ...
            <div class="col-lg-12">
              <input type="text" class="form-control" id="Messengers" name="Messengers" placeholder="Укажите Мессенджер и/или номер телефона">
            </div>
          </div>
          <br>
          <div class="form-group">
            ...
            <div class="col-lg-12">
              <input type="text" class="form-control" id="Recommendations" name="Recommendations" placeholder="Комментарий">
            </div>
          </div>
          <br>
          <br>
          <br>
          <div class="form-group">
            <label for="resume" class="col-lg-12 control-label">Резюме:</label>
            <div class="col-lg-12">
              <input type="file" class="btn btn-default" title="Приложить файл" id="resume" name="file">
            </div>
          </div>
          <br>
          <div class="col-lg-12">
  ...
  <div class="invite-friend">
    <img src="/wp-content/themes/domru/background/photo_2023-06-22_16-46-02.jpg" width="95%" height="95%" alt=""> 
  </div>
